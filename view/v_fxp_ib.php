...
<?php require_once "view/parsial/v_kiri.php"; ?>
        ...
        <section class="content">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Data IB Forexperia <small> < Gunakan tombol Tab untuk filter > </small></h3>
                    <div class="box-tools">
                        <div class="input-group">

                            <div class="input-group-btn">
                                <a href="fxp_ib_t.php"><button class="btn btn-default pull-right"><span class="label label-primary"><i class="fa fa-plus"></i></span>  Tambah Data</button></a>
                                <form method="post" action="cetak/c_fxp_ib.php">
                                    <div id="forms"></div>
                ...
                <div class="box-body table-responsive no-padding">
                    <form name="search_form" id="search_form">
                        <table class="table table-hover">
                            <tr>
                                <td>
                                    <input type="text" id="nama" placeholder="Nama IB" >
    ...
    <script>
        function makeTable(data){                   // create table get data from database
            ...
            var a=1;
            $.each(data.fxp_ib, function(i,user){
                var tbl_row =
                    ""
                        +"<td>"+a+"</td>"
                        +"<td>"+user.nama_ib+"</td>"
                        ...
                        +"<td><a href=fxp_ib_t.php?lihat="+user.id_ib+"><button class='btn btn-sm btn-warning'><i class='fa fa-search'></i></button></a></td>"
                        +"<td><a href=fxp_ib_t.php?edit="+user.id_ib+"><button class='btn btn-sm btn-info'><i class='fa fa-edit'></i></button></a></td>"
                        +"<td><a href=fxp_ib_t.php?hapus="+user.id_ib+"><button class='btn btn-sm btn-danger'><i class='fa fa-trash-o'></i></button></a></td>"
        ...
        function updateEmployees(opts, nama, alamat, telp, email, bb, website){        // update the filter using ajax
            $.ajax({
                ...
                url: "model/m_fxp_ib.php",                      // search. page send data using json
                dataType : 'json',
                cache: false,
                ...
                success: function(records){
                    ...
                    $('#njajal').html(JSON.stringify(records.fxp_ib));
